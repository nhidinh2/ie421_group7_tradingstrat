...
class Group7Strategy : public Strategy {
public:
...
public:
    Group7Strategy(StrategyID strategyID, const std::string& strategyName, const std::string& groupName);
    ~Group7Strategy();
...
extern "C" {
                                   ...
                                   const char* groupName)
    {
        if (strcmp(strategyType,GetType()) == 0) {
            return *(new Group7Strategy(strategyID, strategyName, groupName));
        } else {
            return NULL;
        }
    }
